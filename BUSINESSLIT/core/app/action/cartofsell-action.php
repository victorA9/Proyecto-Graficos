...
<div class="col-md-12">
    ...
    <div class="col-lg-12">
      <input type="hidden" name="invoice_code" class="form-control"  placeholder="No. Factura">
    </div>
  </div>
  </div>
<div class="row">
...
<div class="col-md-6">
    <label class="control-label">Solicitado por via</label>
    <div class="col-lg-12">
    <?php 
...
<div class="col-md-12">
    <label class="control-label"> Conformidad por parte del usuario</label>
    <div class="col-lg-12">
    <?php 
...
<div class="col-md-6">
 ...
 <div class="col-md-6">
    <label class="control-label">Comprobar costo de producto</label>
    <div class="col-lg-12">
