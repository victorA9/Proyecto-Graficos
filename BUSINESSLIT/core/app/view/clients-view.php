...
<div class="row">
	<div class="col-md-12">
		<h1>Directorio de Dependencias</h1>
	<a href="index.php?view=newclient" class="btn btn-default"><i class='fa fa-smile-o'></i> Nueva Dependencia</a>
<div class="btn-group ">
...
<div class="box-body">
			...
			echo "<p class='alert alert-danger'>No hay dependencias</p>";
		}
