...
$objPHPExcel->getProperties()->setCreator("Almacen CJJ")
							 ->setLastModifiedBy("Almacen CJJ")
							 ->setTitle("Almacen CJJ")
							 ->setSubject("Almacen CJJ")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Creditos - Almacen CJJ')
->setCellValue('A2', 'Id')
